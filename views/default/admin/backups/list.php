...
if (!$backup_dir || !file_exists($backup_dir)) {
    ...
    echo elgg_view('output/url', array(
        ...
        'href' => elgg_add_action_tokens_to_url(elgg_get_site_url() . 'action/backup-tool/create'),
...
if ($backups_files) {
    ...
    foreach ($backups_files as $backup) {
        ...
        $buttons .= '<span class="elgg-subtext">' .date("d.m.Y",filemtime($backup_dir.$backup)).'</span>&nbsp;&nbsp;';
